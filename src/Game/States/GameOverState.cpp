...
GameOverState::GameOverState() {
	...
	mainMenuButton = new Button(ofGetWidth()/2, ofGetHeight()/2, 64, 150, "Main Menu"); // added Game Over Menu for convenience -EAHC
...
void GameOverState::render() {
	ofDrawBitmapString("Score: " + to_string(score), ofGetWidth()/2, ofGetHeight()/2-300);
